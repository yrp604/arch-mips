...
extern "C"
{
	...
	uint32_t mips_decompose(const uint32_t* instructionValue, size_t maxSize,
	    Instruction* restrict instruction, MipsVersion version, uint64_t address, uint32_t bigEndian);
